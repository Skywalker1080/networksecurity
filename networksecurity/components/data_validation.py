...
class DataValidation:
    ...
    def detetct_dataset_deift(self, base_df, current_df, threshold=0.05)->bool:
        try:
            status = True
            report = {}
    ...
    def initiate_data_validation(self)->DataIngestionArtifact:
        try:
            ...
            status = self.detetct_dataset_deift(base_df=train_dataframe, current_df=test_dataframe)
